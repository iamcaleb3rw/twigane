...
// Source: ./sanity/lib/courses/getSidebarInfoById.ts
// Variable: getSidebarInfoByIdQuery
// Query: *[_type == "course" && _id == $id][0] {      title,      slug,  // Spread all course fields      "modules": modules[]-> {  // Expand the array of module references        title,  // Include all module fields        "lessons": lessons[]-> {        title,         slug,        videoUrl        }  // For each module, expand its array of lesson references      }    }
export type GetSidebarInfoByIdQueryResult = {
  title: string | null;
  slug: Slug | null;
  modules: Array<{
    title: string | null;
...
// Source: ./sanity/lib/lessons/completeLessonById.ts
// Variable: query
// Query: {      "student": *[_type == "student" && clerkId == $clerkId][0] { _id },      "existingCompletion": *[_type == "lessonCompletion"         && student._ref == ^.student._id         && lesson._ref == $lessonId][0],      "lesson": *[_type == "lesson" && _id == $lessonId][0] {        "module": *[_type == "module" && ^._id in lessons[]._ref][0] {          _id,          "course": *[_type == "course" && ^._id in modules[]._ref][0]._id        }      }    }
